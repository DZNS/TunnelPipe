...
class TunnelPipe {
    ...
    cmdPipe(pipe) {
        ...
        pipe.reduce(function(cur, next, idx) {
            ...
            //current is a promise from the previous run of reduce.
            if(cur.constructor === Promise) {
                ...
                .then(() => {
                    ...
                    var argsB = next.constructor === Object && next.args !== undefined ? next.args : undefined
                    argsB = [self.pwd].concat(argsB || [])
            ...
            if(holeA) {
                ...
                console.log("only A", holeA)

                //here onwards, inside this scope, we assume holeA is a subclass of the Hole Class.
                var args = cur.constructor === Object && cur.args !== undefined ? cur.args : undefined
                args = [self.pwd].concat(args || [])
            ...
            if(holeB) {
                ...
                console.log("only B", holeB)

                //here onwards, inside this scope, we assume holeB is a subclass of the Hole Class.
